...
export const SCENARIOS: ScenarioMeta[] = [
  {
    ...
    subtitle: "Worry & Courage · Ages 6–8",
    description:
  ...
  },
  {
    id: "ch3",
    audience: "child",
    title: "Calm in the Trees",
    subtitle: "Calm & Repair",
    description: "Big feelings cloud the trees. Answer with care and practice calm tools and repair.",
    startSceneId: "c1",
    ageBand: "8-10",
