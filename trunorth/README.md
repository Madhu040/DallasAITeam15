...
- **Showcase golden path** — Level 1 *The Little Dragon Who Wouldn't Stop Guarding* (W1→W6 with Nova & Flicker)
...
```
W1 (quest) → W2 (Forest questions) → W3 (Meadow inspect) → W4 (Valley welcome)
→ W5 (Cave purpose) → W6 (Mountain / Festival steps + Star Crystal)
```
