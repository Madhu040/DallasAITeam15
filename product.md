...
> feedback).** Landed this session (local commits `f9d2174`/`d48e317`/`d450ee0`/`c93f1eb`/…
...
> characters now render with a live fallback — and **Chapter 2 rebuilt with the same
> explore→discover→decide loop** (w1–w6 goals + 12 new discovery dialogs + gated sparks).
> 135 unit + 18 e2e green.
>
